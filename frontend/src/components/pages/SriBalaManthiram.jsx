  ...
  return (
    <>
      ...
      <main className="ug-page-main sbm-page-main">
        <section className="ug-hero sbm-hero" aria-label="Sri Bala Tripurasundari">
            <img src="/assets/img/god/bala banner.jpeg" alt="Sri Bala Tripurasundari Divine Banner" width="1920" height="600" className="ug-hero-image sbm-hero-image" loading="eager" fetchpriority="high" />
            ...
            <div className="site-container container sbm-intro-shell">
                <aside className="sbm-card sbm-intro-media" aria-label="Sri Bala visual">
                    <div className="sbm-intro-media-frame">
                        <img src="/assets/img/god/Sri Bala.png" alt="Sri Bala divine form" width="400" height="500" loading="lazy" decoding="async" className="sbm-intro-image" />
