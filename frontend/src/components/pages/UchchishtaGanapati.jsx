    ...
    <>
      ...
      <main className="ug-page-main">
        ...
        <section className="ug-hero" aria-label="Uchchishta Ganapati">
            <img src="/assets/img/ganapathi/Untitled design.jpg.jpeg" alt="Uchchishta Ganapati Sacred Banner" width="1920" height="600" className="ug-hero-image" loading="eager" fetchpriority="high" />
        ...
        <section className="ug-intro section section-padding">
            ...
            <aside className="ug-card ug-video-card" aria-label="Video placeholder">
                <img src="/assets/img/ganapathi/Untitled design 1.jpg.jpeg" alt="Uchchishta Ganapati depiction" width="600" height="400" loading="lazy" decoding="async" className="ug-video-image" />
            </aside>
